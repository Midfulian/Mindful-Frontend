...
class DoctorProfileUserPage extends StatefulWidget {
  const DoctorProfileUserPage({super.key});

  @override
  State<DoctorProfileUserPage> createState() => _DoctorProfileUserPageState();
}

class _DoctorProfileUserPageState extends State<DoctorProfileUserPage> {
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.fromLTRB(
                          screenWidth * 0.09, screenWidth * 0.01, 0, 0),
                      child: Text(
                        "Chardiologist",
                        style: TextStyle(
                            color: Colors.blue,
                    ...
                    Padding(
                      padding: EdgeInsets.fromLTRB(
                          screenWidth * 0.09, screenWidth * 0.02, 0, 0),
                      child: Row(
                        children: [
                          Icon(
                            Icons.star,
